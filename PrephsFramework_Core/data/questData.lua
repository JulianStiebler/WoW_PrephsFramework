--[[
    <PrephsFramework_Core/data/questData.lua>
...
local questData = Core.data.questData
...
--- Return the quest name for a given ID, or nil if unknown.
---@param questID number
---@return string?
function questData:GetQuestName(questID)
    return self.entries[questID]
end

function questData:QuestIDInTable(questID, questTable)
    for _, qid in ipairs(questTable) do
        if qid == questID then
            return true
        end
    end
