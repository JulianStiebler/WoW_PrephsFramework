...
do
	...
	--- @param filter number # ALL_RUNES_CATEGORY, EQUIPPED_RUNES_CATEGORY, or a slot category ID
...
--- Hides all pre-created header buttons on the EngravingFrame
...
--- Rebuilds the visible rune list, positioning category headers and rune buttons
--- @param self EngravingFrame
...
--- Updates the "X/Y Runes Collected" label, filtered by current exclusive category if applicable
--- @param self EngravingFrame
...
--- Calculates the scroll index and remaining pixel offset for hybrid scroll
--- @param offset number # Pixel offset into the scroll list
--- @return number index # 0-based row index
--- @return number heightLeft # Remaining pixel offset within the row
...
--- @param self EngravingFrameSearchBox
...
--- @param self RuneHeaderButtonTemplate
--- @param button string
...
--- @param self RuneSpellButtonTemplate
--- @param button string
