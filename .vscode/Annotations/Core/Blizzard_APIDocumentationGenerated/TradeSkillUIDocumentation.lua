...
---@return number skillLineID - TradeSkillLineID.
---@return string skillLineDisplayName - Localized name.
---@return number skillLineRank - Current skill level.
---@return number skillLineMaxRank - Maximum attainable skill level.
---@return number skillLineModifier - Modifiers to the skill level (such as +mining
---@return number parentSkillLineID - TradeSkillLineID of the parent tradeskill (i.e. Alchemy if this skill is Legion Alchemy)
---@return string? parentSkillLineDisplayName - Localized name of the parent tradeskill.
